...
class RockPaperScissorsPage extends StatefulWidget {
  ...
  RockPaperScissorsPage({Key? key, required this.tagType}) : super(key: key);

  @override
  RockPaperScissorsPageState createState() => RockPaperScissorsPageState();
...
class RockPaperScissorsPageState extends State<RockPaperScissorsPage>
    with ToastMixin {
  ...
  void openQrCode() {
    String strBettingAddress = getBetaddress(10)!;
    SmartDialog.show(
      backDismiss: false,
        ...
        child: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              ...
              Pin(size: 35.0, start: 795.0),
              child: Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image:
                        const AssetImage('assets/images/introduce_banner1.png'),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
                        ...
                        child: Column(
                          children: [
                            Text('Case1'.tr,
                                ...
                                textAlign: TextAlign.center),
                            Text('caseA RockPaperScissors'.tr,
                                style: TextStyle(
                        ...
                        child: Column(
                          children: [
                            Text('Case2'.tr,
                                ...
                                textAlign: TextAlign.center),
                            Text('caseB RockPaperScissors'.tr,
                                style: TextStyle(
                                    color: Colors.white, fontSize: 12),
                                textAlign: TextAlign.center),
                          ],
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: const AssetImage(
                                      'assets/images/rock_paper_scissor1.png'),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: const AssetImage(
                                      'assets/images/rock_paper_scissor2.png'),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
            ...
            Pinned.fromPins(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(Pin(size: 200.0, start: 04.0),
