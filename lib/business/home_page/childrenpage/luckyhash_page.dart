...
class LuckyHashPage extends StatefulWidget {
  String tagType;

  LuckyHashPage({Key? key, required this.tagType}) : super(key: key);

  @override
  LuckyHashPageState createState() => LuckyHashPageState();
}

class LuckyHashPageState extends State<LuckyHashPage> with ToastMixin {
  ...
  void openQrCode() {
    String strBettingAddress = getBetaddress(5)!;
    SmartDialog.show(
      backDismiss: false,
      ...
      child: SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(size: 260.0, start: 17.0),
                    Pin(size: 27.0, middle: 0.9692),
                    child: Text(
                      'numbers & alphabet alphabet & numbers'.tr,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontFamily: 'PingFang SC',
                        fontSize: 11.6,
            ...
            Pinned.fromPins(
              Pin(start: 0.0, end: 0.0),
              Pin(size: 129.0, start: 92.0),
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(size: 148.0, start: 65.0),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Align(
                          alignment: Alignment(0.83, 0.780),
                          child: SizedBox(
                            width: 20.0,
                            height: 25.0,
                            child: Text(
