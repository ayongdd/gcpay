...
class LuckyNumberPage extends StatefulWidget {
  ...
  LuckyNumberPage({Key? key, required this.tagType}) : super(key: key);

  @override
  LuckyNumberPageState createState() => LuckyNumberPageState();
...
class LuckyNumberPageState extends State<LuckyNumberPage> with ToastMixin {
  ...
  void openQrCode() {
    String strBettingAddress = getBetaddress(9)!;
    SmartDialog.show(
      backDismiss: false,
            ...
            Pinned.fromPins(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 9.0, 0.0, 2.0),
                    child: Stack(
                      children: <Widget>[
                        Container(
                          decoration: BoxDecoration(
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          Pin(size: 134.0, start: 70.0),
                          Pin(size: 24.0, middle: 0.5006),
                          child: Text(
                            'Transfer amount'.tr,
                            textAlign: TextAlign.center,
                            style: TextStyle(
                        ...
                        Pinned.fromPins(
                          Pin(size: 108.0, start: 85.0),
                          Pin(size: 24.0, middle: 0.8302),
                          child: Text(
                            'Result'.tr,
                            textAlign: TextAlign.center,
                            style: TextStyle(
                        ...
                        Pinned.fromPins(
                          Pin(size: 258.0, start: 10.0),
                          Pin(size: 87.0, middle: 0.1800),
                          child: Text(
                        ...
                        Pinned.fromPins(
                          ...
                          child: Container(
                            ...
                            child: Text(
                                'lastDigitsOfLetter luckyNumber'.tr,
                                style: TextStyle(color: Colors.white, fontSize: 12),
                                textAlign: TextAlign.center
                            ),
                          ),
                        ...
                        Align(
                          alignment: Alignment(0.88, -0.315),
                          child: SizedBox(
                            width: 28.0,
                            height: 28.0,
                            child: Stack(
            ...
            Pinned.fromPins(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  InkWell(
                    child: Align(
                      alignment: Alignment(0.617, 0.613),
                      child: SizedBox(
                        width: 16.0,
                        height: 16.0,
                        child: Stack(
                          children: <Widget>[
                            ...
                            Padding(
                              padding: EdgeInsets.fromLTRB(0.0, 0.0, 2.9, 0.0),
                  ...
                  Pinned.fromPins(
                      Pin(size: 16.7, end: 10.3), Pin(size: 18.0, end: 12.0),
                      child: InkWell(
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
