...
class HashNiuNiuPage extends StatefulWidget {
  String tagType;

  HashNiuNiuPage({Key? key, required this.tagType}) : super(key: key);

  @override
  HashNiuNiuPageState createState() => HashNiuNiuPageState();
...
class HashNiuNiuPageState extends State<HashNiuNiuPage> with ToastMixin {
  ...
  void openQrCode() {
    String strBettingAddress = getBetaddress(4)!;
    SmartDialog.show(
      backDismiss: false,
      ...
      child: SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              Pin(start: 0.0, end: 0.0),
              Pin(size: 155.0, middle: 0.6698),
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(start: 0.0, end: 0.0),
                    Pin(size: 145.0, end: 6.0),
                    child: Container(
                      decoration: BoxDecoration(
                        color: const Color(0xfe01231b),
                        borderRadius: BorderRadius.circular(10.0),
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 5.0, 0.0, 6.0),
                    child: Stack(
                      children: <Widget>[
                        Container(
                          decoration: BoxDecoration(
            ...
            Pinned.fromPins(
              Pin(start: 0.0, end: 0.0),
              Pin(size: 155.0, middle: 0.4800),
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(start: 0.0, end: 0.0),
                    Pin(size: 135.0, end: 18.0),
                    child: Container(
                      decoration: BoxDecoration(
                        color: const Color(0xfe01231b),
                        borderRadius: BorderRadius.circular(10.0),
            ...
            Pinned.fromPins(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(size: 179.0, start: 50.0),
                    Pin(size: 24.0, middle: 0.4001),
                    child: Text(
                      'PlayerWin HashBull'.tr,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontFamily: 'inpin nanzhengbeizhanNZBZti',
                        fontSize: 13,
                  ...
                  Pinned.fromPins(
                    Pin(size: 134.0, start: 76.0),
                    Pin(size: 24.0, middle: 0.6370),
                    child: Text(
                      'Banker Win'.tr,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                  ...
                  Pinned.fromPins(
                    ...
                    child: Container(
                      ...
                      child: Text(
                          'Player Win  Bonus= betting amount*player points*0.95+transfer amount'.tr,
                  ...
                  Pinned.fromPins(
                    Pin(start: 16.0, end: 13.0),
                    Pin(size: 55.0, end: 68.0),
                    child: Container(
                      height: 5,
                      alignment: Alignment.center,
                      decoration: const BoxDecoration(
                      ...
                      child: Text(
                          'Banker Win Bonus= Transfer amount-betting amount*banker points'.tr,
                          style: TextStyle(color: Colors.white, fontSize: 11),
                          textAlign: TextAlign.center
                      ),
                    ),
                  ...
                  Align(
                      alignment: Alignment(0.84, -0.399),
                    child: SizedBox(
                      width: 50.0,
                      height: 31.0,
                      child: Stack(
                        children: <Widget>[
                          Padding(
                            padding: EdgeInsets.fromLTRB(6.0, 5.0, 5.0, 3.0),
                          ...
                          Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 1.0, color: const Color(0xffffcf21)),
                            ),
                          ),
                        ],
                      ),
                    ...
                    child: SizedBox(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromPins(Pin(size: 16.7, end: 10.3),
