...
import 'package:GCPay/utils/method_channel.dart';

import '../../http/apiservice/gcpay_api.dart';
import '../../http/apiservice/haxi_api.dart';
import '../../routes/app_routes.dart';
import 'model/BetRecord_AmountTotal.dart';

class RecordPage extends BaseStatefulWidget<RecordController> {
  const RecordPage({Key? key}) : super(key: key);

  String getCurrencySymbol() {
    if (controller.rxTransferType.value == 'usdt') {
      return 'USDT';
    } else {
      return 'TRX';
    }
  ...
  String getAgentBetBonus() {
    if (controller.betrecordTotal.value.agentBetBonus != null) {
      return controller.betrecordTotal.value.agentBetBonus!.toStringAsFixed(2);
    } else {
      return '0';
    }
  }
              ...
              child: SingleChildScrollView(
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.fromLTRB(0.0, 169.0, 0.0, 0),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                                  ...
                                  Obx(() => FlutterToggleTab(
                                    ...
                                    selectedLabelIndex: (index) {
                                      controller._tabTextIndexSelected.value =
                                          index;
                                      if (index == 0) {
                                        controller.rxTransferType.value =
                                        'usdt';
                                        controller.getBetRecordInfo();
                                      } else {
                                        controller.rxTransferType.value =
                            ...
                            Pinned.fromPins(
                              Pin(size: 300.0, middle: 0.4062),
                              Pin(size: 65.0, start: 54.0),
                              child: Stack(
                                children: <Widget>[
                                  Container(
                            ...
                            Pinned.fromPins(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Align(
                                    alignment: Alignment(-0.787, 0.869),
                                    child: SizedBox(
                                      width: 88.0,
                                      height: 20.0,
                                      child: Obx(() => Text(
                                        controller.betrecordTotal.value
                                            .agentBetAmount !=
                                            null
                                            ? controller.betrecordTotal.value
                                            .today!.betAmount!
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      Get.toNamed(AppRoutes.BetRecordAmountPage,arguments:controller.rxTransferType.value);
                                    },
                                  ),
                                ],
                              ),
                            ...
                            Pinned.fromPins(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Pinned.fromPins(
                                    Pin(size: 220.0, start: 27.0),
                                    Pin(size: 40.0, middle: 0.6385),
                                    child: Text(
                                      'Total winnings Amount'.tr,
                                      style: TextStyle(
                                        fontFamily: 'PingFang SC',
                                        fontSize: 14,
                                        color: colorScheme.primary,
                                  ...
                                  Align(
                                    alignment: Alignment(-0.827, 0.869),
                                    child: SizedBox(
                                      width: 68.0,
                                      height: 20.0,
                                      child: Obx(() => Text(
                                  ...
                                  InkWell(child: Pinned.fromPins(
                                    ...
                                    Get.toNamed(AppRoutes.BetRecordHistoryPage,arguments:controller.rxTransferType.value);
                                  },),
                                ],
                              ),
                            ),
                            Pinned.fromPins(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Align(
                                    alignment: Alignment(-0.807, 0.869),
                                    child: SizedBox(
                                      width: 8.0,
                                      height: 20.0,
                                      child: Obx(() => Text(
                                  ...
                                  Pinned.fromPins(
                                    Pin(size: 140.0, end: 20.0),
                                    Pin(size: 20.0, middle: 0.7846),
                                    child: Text(
                                      'Yesterday Betting Times'.tr,
                                      textAlign: TextAlign.right,
                                      style: TextStyle(
                                        fontFamily: 'PingFang SC',
                                        fontSize: 14,
                            ...
                            Pinned.fromPins(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Pinned.fromPins(
                                    Pin(size: 116.0, start: 27.0),
                                    Pin(size: 40.0, middle: 0.9046),
                                    child: Text(
                                      'Downline winning'.tr,
                                      style: TextStyle(
                                        fontFamily: 'PingFang SC',
                                  ...
                                  Align(
                                    alignment: Alignment(-0.787, 0.779),
                                    child: SizedBox(
                                      width: 60.0,
                                      height: 15.0,
                                      child: Obx(() => Text(
                                  ...
                                  Align(
                                    alignment: Alignment(0.88, 0.779),
                                    child: SizedBox(
                                      width: 28.0,
                                      height: 15.0,
                                      child: Obx(() => Text(
                                  ...
                                  InkWell(child: Pinned.fromPins(
                                    ...
                                    Get.toNamed(AppRoutes.BetRecordInferiorPage,arguments:controller.rxTransferType.value);
                                  },)
                      ...
                      Pinned.fromPins(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            InkWell(
                              child: Pinned.fromPins(
                                Pin(size: 66.0, start: 40.0),
                                Pin(size: 35.0, middle: 0.7538),
                                child: Text(
                                  'betting record'.tr,
                                  style: TextStyle(
                                    fontFamily: 'PingFang SC',
                            ...
                            Align(
                              ...
                              child: SizedBox(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Get.toNamed(AppRoutes.BetRecordPage,arguments:controller.rxTransferType.value);
                                  },
                                ),
                              ),
                            ),
                            Align(
                              ...
                              child: SizedBox(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Get.toNamed(AppRoutes.WithdrawRecordPage,arguments:controller.rxTransferType.value);
                                  },
                                ),
                              ),
                            ),
                            Align(
                              ...
                              child: SizedBox(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    Get.toNamed(AppRoutes.RebateRecordPage,arguments:controller.rxTransferType.value);
                                  },
                                ),
                              ),
                            ),
...
class RecordController extends BaseController {
  ...
  Rx<BetRecordAmountTotal> betrecordTotal = new BetRecordAmountTotal().obs;
  ...
  Future<void> getBetRecordInfo() async {
    try {
      Map<String, dynamic> data = <String, dynamic>{
        'timeType': 'month',
        'transferType': rxTransferType.value,
      };
      var response;// = await _gcpayApi.getTronInRecordAmountTotal(data);
      if (response.code == 401) {
        // Get.toNamed(Routes.LOGIN);
      }
      if (response.code == 200) {
        //return json.decode(response.body);
        betrecordTotal.value = response.data!;
