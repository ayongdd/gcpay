...
class AuthApiService extends ApiService {
  ...
  static String editPwUrl = '/api/user/editLoginPwd';
  static String editPayUrl = '/api/user/editPayPwd';
  ...
  Future<Response<dynamic>> editLoginPwd(Map<String, dynamic> data) async {
    return post(editPwUrl, {
  ...
  Future<Response<dynamic>> editPayPwd(Map<String, dynamic> data) async {
    return post(editPayUrl, {
      'confirm': data['confirm'],
      'original': data['original'],
      'password': data['password'],
