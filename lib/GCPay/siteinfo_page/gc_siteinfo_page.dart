...
class SiteInfoPage extends BaseStatefulWidget<SiteInfoController> {
  const SiteInfoPage({Key? key}) : super(key: key);
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  //   ),
                  // ),
                  Pinned.fromPins(Pin(size: 280.0, middle: 0.5),
                  ...
                  //scrollview
                  Obx(() => controller.siteInfoList.length > 0
                      ? Pinned.fromPins(
                          ...
                          child: ListView(
                            ...
                            children: controller.siteInfoList.map((itemData) {
                              return SizedBox(
                                width: 435.0,
                                height: 142.0,
                                child: Stack(
                                  children: <Widget>[
                                    Pinned.fromPins(
                                          ...
                                          child: InkWell(
                                            ...
                                            if (controller.intMessageType == 1) {
                                              controller.cacheservice
                                                  .siteInfoData = itemData;
                                              Get.toNamed(
                                                  AppRoutes.MessageDetailPage);
                                            }
                                          }
                                        ),),
                                    Pinned.fromPins(
                          ...
                          child: Pinned.fromPins(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/images/messagenotification.png',
                                    height: 60,
                                  ),
                                  Container(
                                    height: 10,
...
class SiteInfoController extends BaseController {
  ...
  SiteInfoController(this.cacheservice, this.gcpayApi);
  ...
  void onReady() {
    ...
    rxMessageType.value = dataArguments['messagetype']!;
  ...
  Future<void> getSiteInfo() async {
    try {
      Map<String, dynamic> data = <String, dynamic>{'type': intMessageType};
...
class SiteInfoBinding extends Bindings {
  ...
  void dependencies() {
    Get.lazyPut(
        () => SiteInfoController(Get.put(CacheService()), Get.put(GCPayApi())));
  }
}
